@php
    /** @var $element */
    $bands = view('collection.names.string', array('collection' => $element->bands, 'delimiter' => '; ', 'no_quotes' => true));
            ...
            <div class="col-md-3 mb-4">
                <div class="card @include('card.class')">
                    ...
                    <div id="transfer" class="card-footer text-center">
                        @include('card.transfer', array('controller' => 'AlbumsController', 'element' => $element))
                    </div>
                </div>
            </div>
        </div>
