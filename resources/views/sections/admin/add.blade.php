        ...
        @if('films' == $section)
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-4">
                    ...
                    <div class="card">
                        <div class="card-header" data-toggle="collapse" data-target="#films_genres_container"
                             aria-expanded="false" aria-controls="films_genres_container">
                            Жанры фильмов
                        </div>
                    ...
                    <div class="card mt-3">
                        <div class="card-header" data-toggle="collapse" data-target="#countries_container"
                             aria-expanded="false" aria-controls="countries_container">
                            Страны
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9 mb-4">
                    ...
                    <ol id="tracks">
                        ...
                        $tracks = '';
                        for ($i = 0; $i < 9; $i++) {
                            $tracks .= '<li><input type="text" class="form-control w-100 mb-3" name="tracks[]" placeholder="Трек" /></li>';
                        }
                        echo $tracks;
                        ?>
                    </ol>
