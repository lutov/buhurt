...
@section('content')
	...
	<div class="tab-content" id="myTabContent">
		...
		@if(count($persons))
			<div class="tab-pane fade @if(array_key_first($titles) === 'persons') show active @endif" id="persons" role="tabpanel" aria-labelledby="persons-tab">
				<div class="row">
					<div class="col-md-12">
		...
		@if(count($bands))
			<div class="tab-pane fade @if(array_key_first($titles) === 'bands') show active @endif" id="bands" role="tabpanel" aria-labelledby="bands-tab">
				<div class="row">
					<div class="col-md-12">
