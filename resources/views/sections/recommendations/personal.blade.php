                    ...
                    <fieldset class="col-md-12">
                        ...
                        <div class="custom-control custom-radio custom-control-inline"
                            ...
                            <input type="radio" id="element_type_books" name="element_type" value="books"
                                   ...
                                   @if('books' == $section) checked @endif>
                        ...
                        <div class="custom-control custom-radio custom-control-inline"
                            ...
                            <input type="radio" id="element_type_films" name="element_type" value="films"
                                   class="custom-control-input" autocomplete="off"
                                   @if('films' == $section) checked @endif>
                        ...
                        <div class="custom-control custom-radio custom-control-inline"
                            ...
                            <input type="radio" id="element_type_games" name="element_type" value="games"
                                   class="custom-control-input" autocomplete="off"
                                   @if('games' == $section) checked @endif>
                        ...
                        <div class="collapse" id="collapseDetails">
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" id="liked_genres" name="recommendation_principle"
                                       value="liked_genres" class="custom-control-input" autocomplete="off"
                                       @if('liked_genres' == $principle) checked @endif>
                                <label class="custom-control-label" for="liked_genres">В жанрах, которые я хорошо
                                    оцениваю</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" id="faved_genres" name="recommendation_principle"
                                       value="faved_genres" class="custom-control-input" autocomplete="off"
                                       @if('faved_genres' == $principle) checked @endif>
                                <label class="custom-control-label" for="faved_genres">В жанрах, которые я часто
                                    оцениваю</label>
                            </div>
                            <!--div class="custom-control custom-radio">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="include_wanted" value="1"
                                       id="include_wanted" @if($options['include_wanted']) checked @endif>
                                <label class="custom-control-label" for="include_wanted">Включать произведения из списка
                                    желаемого</label>
                            </div>
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="include_unwanted" value="1"
                                       id="include_unwanted" @if($options['include_unwanted']) checked @endif>
                                <label class="custom-control-label" for="include_unwanted">Включать произведения из
                                    списка нежелаемого</label>
                            </div>
