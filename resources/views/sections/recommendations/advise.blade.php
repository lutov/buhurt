...
@section('content')
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#book_tab" role="tab" aria-controls="book"
               aria-selected="true">Почитать</a>
        </li>

        <li class="nav-item">
            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#film_tab" role="tab" aria-controls="film"
               aria-selected="false">Посмотреть</a>
        </li>

        <li class="nav-item">
            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#game_tab" role="tab" aria-controls="game"
               aria-selected="false">Поиграть</a>
        </li>

        <li class="nav-item">
            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#album_tab" role="tab" aria-controls="album"
               aria-selected="false">Послушать</a>
        </li>
