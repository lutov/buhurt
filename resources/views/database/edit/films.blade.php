@php
    /** @var $element */
    $directors = view('widgets.string-collection-names', array('collection' => $element->directors, 'delimiter' => '; ', 'no_quotes' => true));
    $screenwriters = view('widgets.string-collection-names', array('collection' => $element->screenwriters, 'delimiter' => '; ', 'no_quotes' => true));
    $producers = view('widgets.string-collection-names', array('collection' => $element->producers, 'delimiter' => '; ', 'no_quotes' => true));
    $genres = view('widgets.string-collection-names', array('collection' => $element->genres, 'delimiter' => '; ', 'no_quotes' => true));
    $countries = view('widgets.string-collection-names', array('collection' => $element->countries, 'delimiter' => '; ', 'no_quotes' => true));
    $actors = view('widgets.string-collection-names', array('collection' => $element->actors, 'delimiter' => '; ', 'no_quotes' => true));
            ...
            <div class="col-md-3">
                <div class="card @include('widgets.card-class')">
                    ...
                    <div class="collapse" id="countries_list_container">
                        @include('widgets.list-collection-names', array('id' => 'countries_list', 'collection' => ElementsHelper::getCountries()))
                    </div>
                    ...
                    <div id="transfer" class="card-footer text-center">
                        @include('widgets.card-transfer', array('controller' => 'FilmsController', 'element' => $element))
                    </div>
                </div>
            </div>
        </div>
