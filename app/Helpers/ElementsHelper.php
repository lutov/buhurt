...
class ElementsHelper
{
    ...
    public static function getCardDetails(string $section, $element, bool $isAdmin = false)
    {
        ...
        if (!empty(trim($element->description))) {
            $element_body .= '<div class="card-body" itemprop="description">';
            $element_body .= '<p class="card-text">';
        ...
        if ($element->tracks) {
            $element_body .= '<ol class="list-group list-group-flush">';
            $element_body .= '<li class="list-group-item">'.DatatypeHelper::objectToJsArray(
                    $element->tracks,
            ...
            $element_body .= '<div class="card-body">';
        ...
        $element_body .= '<div class="card-body small">';
        ...
        if (!empty($main_info)) {
            $element_body .= '<div class="card-body small">';
            $element_body .= '<p class="card-text">'.$main_info.'</p>';
            $element_body .= '</div>';
        }
